...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms//store/cmst3/group/softJets/common/signal_samples_140X/chain_m70_dm20_cfgRun24_140X_Run2024_test_03062025/Mini/job_100_step4.root'),
...
process.QGTagger = cms.EDProducer("QGTagger",
    ...
    srcJets = cms.InputTag("selectedUpdatedPatJetsAK4PuppiFinal"),
...
process.ak4GenChargedJetsRecluster = cms.EDProducer("FastjetJetProducer",
    ...
    src = cms.InputTag("packedGenChargedParticles"),
    srcPVs = cms.InputTag(""),
...
process.patGenChargedJetMatchRecluster = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak4GenChargedJetsRecluster"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
    mcStatus = cms.vint32(),
    resolveAmbiguities = cms.bool(True),
    resolveByMatchQuality = cms.bool(False),
    src = cms.InputTag("selectedUpdatedPatJetsAK4PuppiFinal")
)


process.patGenJetMatchAllowDuplicates = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak4GenChargedJetsRecluster"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
...
process.patJetCorrFactorsAK4PuppiFinal = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    ...
    src = cms.InputTag("selectedPatJetsAK4PuppiRecluster"),
...
process.patJetCorrFactorsTransientCorrectedAK4PuppiFinal = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring(
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("updatedPatJetsAK4PuppiFinal"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)
...
process.pfDeepCSVJetTagsAK4PuppiFinal = cms.EDProducer("DeepFlavourJetTagsProducer",
    ...
    src = cms.InputTag("pfDeepCSVTagInfosAK4PuppiFinal"),
    toAdd = cms.PSet(
...
process.pfDeepCSVTagInfosAK4PuppiFinal = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
        SoftLeptonFlip = cms.bool(False),
        charmCut = cms.double(1.5),
        correctVertexMass = cms.bool(True),
    ...
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAK4PuppiFinal")
)


process.pfDeepFlavourJetTagsAK4PuppiFinal = cms.EDProducer("DeepFlavourONNXJetTagsProducer",
    ...
    src = cms.InputTag("pfDeepFlavourTagInfosAK4PuppiFinal")
)


process.pfDeepFlavourTagInfosAK4PuppiFinal = cms.EDProducer("DeepFlavourTagInfoProducer",
    ...
    jets = cms.InputTag("updatedPatJetsAK4PuppiFinal"),
    ...
    shallow_tag_infos = cms.InputTag("pfDeepCSVTagInfosAK4PuppiFinal"),
...
process.pfImpactParameterTagInfosAK4PuppiFinal = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
...
process.pfInclusiveSecondaryVertexFinderTagInfosAK4PuppiFinal = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterTagInfosAK4PuppiFinal"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfParticleNetAK4DiscriminatorsJetTagsAK4PuppiFinal = cms.EDProducer("BTagProbabilityToDiscriminator",
    discriminators = cms.VPSet(
        cms.PSet(
            denominator = cms.VInputTag(
                cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probcc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probuds"),
                cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probg")
            ),
            name = cms.string('BvsAll'),
            numerator = cms.VInputTag(cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probbb"))
        ),
        cms.PSet(
            denominator = cms.VInputTag(cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probcc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probuds"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probg")),
            name = cms.string('CvsL'),
            numerator = cms.VInputTag(cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probcc"))
        ),
        cms.PSet(
            denominator = cms.VInputTag(cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probcc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probbb")),
            name = cms.string('CvsB'),
            numerator = cms.VInputTag(cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probcc"))
        ),
        cms.PSet(
            denominator = cms.VInputTag(cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probuds"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probg")),
            name = cms.string('QvsG'),
            numerator = cms.VInputTag(cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probuds"))
        )
    )
)


process.pfParticleNetAK4JetTagsAK4PuppiFinal = cms.EDProducer("BoostedJetONNXJetTagsProducer",
    ...
    src = cms.InputTag("pfParticleNetAK4TagInfosAK4PuppiFinal")
)


process.pfParticleNetAK4TagInfosAK4PuppiFinal = cms.EDProducer("DeepBoostedJetTagInfoProducer",
...
process.pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal = cms.EDProducer("BoostedJetONNXJetTagsProducer",
    debugMode = cms.untracked.bool(False),
    flav_names = cms.vstring(
        'probmu',
        'probele',
    ...
    produceValueMap = cms.untracked.bool(False),
    src = cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralTagInfosAK4PuppiFinal")
)


process.pfParticleNetFromMiniAODAK4PuppiCentralTagInfosAK4PuppiFinal = cms.EDProducer("ParticleNetFeatureEvaluator",
...
process.pfParticleTransformerAK4JetTagsAK4PuppiFinal = cms.EDProducer("ParticleTransformerAK4ONNXJetTagsProducer",
    flav_names = cms.vstring(
        'probb',
        'probbb',
        'problepb',
    ...
    src = cms.InputTag("pfParticleTransformerAK4TagInfosAK4PuppiFinal")
)


process.pfParticleTransformerAK4TagInfosAK4PuppiFinal = cms.EDProducer("ParticleTransformerAK4TagInfoProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    fallback_puppi_weight = cms.bool(False),
    fallback_vertex_association = cms.bool(False),
    flip = cms.bool(False),
...
process.pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal = cms.EDProducer("BTagProbabilityToDiscriminator",
    discriminators = cms.VPSet(
        cms.PSet(
            denominator = cms.VInputTag(
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","problepb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probs"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probu"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probd"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probg")
            ),
            name = cms.string('BvsAll'),
            numerator = cms.VInputTag(cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","problepb"))
        ),
        cms.PSet(
            denominator = cms.VInputTag(cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probs"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probu"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probd"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probg")),
            name = cms.string('CvsL'),
            numerator = cms.VInputTag(cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probc"))
        ),
        cms.PSet(
            denominator = cms.VInputTag(cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","problepb")),
            name = cms.string('CvsB'),
            numerator = cms.VInputTag(cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probc"))
        ),
        cms.PSet(
            denominator = cms.VInputTag(cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probs"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probu"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probd"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probg")),
            name = cms.string('QvsG'),
            numerator = cms.VInputTag(cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probs"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probu"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probd"))
        ),
        cms.PSet(
            denominator = cms.VInputTag(
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","problepb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probs"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probu"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probd"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probg"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h1p"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h1p"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h1p")
            ),
            name = cms.string('TauVsJet'),
            numerator = cms.VInputTag(
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h1p"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h1p")
            )
        ),
        cms.PSet(
            denominator = cms.VInputTag(
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probele"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h0p"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h0p"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h1p")
            ),
        ...
        cms.PSet(
            denominator = cms.VInputTag(
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probmu"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h0p"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h0p"),
                cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h1p")
            ),
...
process.pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal = cms.EDProducer("UnifiedParticleTransformerAK4ONNXJetTagsProducer",
    flav_names = cms.vstring(
        'probb',
        'probbb',
        'problepb',
    ...
    output_names = cms.vstring('softmax'),
    src = cms.InputTag("pfUnifiedParticleTransformerAK4TagInfosAK4PuppiFinal")
)


process.pfUnifiedParticleTransformerAK4TagInfosAK4PuppiFinal = cms.EDProducer("UnifiedParticleTransformerAK4TagInfoProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    fallback_puppi_weight = cms.bool(False),
    fallback_vertex_association = cms.bool(False),
    flip = cms.bool(False),
...
process.updatedPatJetsAK4PuppiFinal = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(False),
    discriminatorSources = cms.VInputTag(),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAK4PuppiFinal")),
    jetSource = cms.InputTag("selectedPatJetsAK4PuppiRecluster"),
    mightGet = cms.optional.untracked.vstring,
...
process.updatedPatJetsTransientCorrectedAK4PuppiFinal = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(True),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(
        cms.InputTag("pfDeepCSVJetTagsAK4PuppiFinal","probb"), cms.InputTag("pfDeepCSVJetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfDeepCSVJetTagsAK4PuppiFinal","probc"), cms.InputTag("pfDeepCSVJetTagsAK4PuppiFinal","probudsg"), cms.InputTag("pfDeepFlavourJetTagsAK4PuppiFinal","probb"),
        cms.InputTag("pfDeepFlavourJetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfDeepFlavourJetTagsAK4PuppiFinal","probc"), cms.InputTag("pfDeepFlavourJetTagsAK4PuppiFinal","probg"), cms.InputTag("pfDeepFlavourJetTagsAK4PuppiFinal","problepb"), cms.InputTag("pfDeepFlavourJetTagsAK4PuppiFinal","probuds"),
        cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probcc"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probg"),
        cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probpu"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probuds"), cms.InputTag("pfParticleNetAK4JetTagsAK4PuppiFinal","probundef"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probb"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probc"),
        cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probele"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probg"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probmu"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaum1h0p"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaum1h1p"),
        cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaum1h2p"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaum3h0p"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaum3h1p"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaup1h0p"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaup1h1p"),
        cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaup1h2p"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaup3h0p"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probtaup3h1p"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","probuds"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","ptcorr"),
        cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","ptnu"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","ptreshigh"), cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal","ptreslow"), cms.InputTag("pfParticleTransformerAK4JetTagsAK4PuppiFinal","probb"), cms.InputTag("pfParticleTransformerAK4JetTagsAK4PuppiFinal","probbb"),
        cms.InputTag("pfParticleTransformerAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfParticleTransformerAK4JetTagsAK4PuppiFinal","probg"), cms.InputTag("pfParticleTransformerAK4JetTagsAK4PuppiFinal","problepb"), cms.InputTag("pfParticleTransformerAK4JetTagsAK4PuppiFinal","probuds"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probb"),
        cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probbb"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probc"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probd"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probdimudata"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probdimumc"),
        cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probele"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probemudata"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probemumc"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probg"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","problepb"),
        cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probmu"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probmutaudata"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probmutaumc"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probs"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h0p"),
        cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaum3h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h0p"),
        cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup1h2p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h0p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probtaup3h1p"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","probu"),
        cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","ptcorr"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","ptnu"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","ptreshigh"), cms.InputTag("pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal","ptreslow"), cms.InputTag("pfParticleNetAK4DiscriminatorsJetTagsAK4PuppiFinal","BvsAll"),
        cms.InputTag("pfParticleNetAK4DiscriminatorsJetTagsAK4PuppiFinal","CvsB"), cms.InputTag("pfParticleNetAK4DiscriminatorsJetTagsAK4PuppiFinal","CvsL"), cms.InputTag("pfParticleNetAK4DiscriminatorsJetTagsAK4PuppiFinal","QvsG"), cms.InputTag("pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal","BvsAll"), cms.InputTag("pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal","CvsB"),
        cms.InputTag("pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal","CvsL"), cms.InputTag("pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal","QvsG"), cms.InputTag("pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal","TauVsEle"), cms.InputTag("pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal","TauVsJet"), cms.InputTag("pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal","TauVsMu")
    ),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsTransientCorrectedAK4PuppiFinal")),
    jetSource = cms.InputTag("updatedPatJetsAK4PuppiFinal"),
    mightGet = cms.optional.untracked.vstring,
    printWarning = cms.bool(True),
    sort = cms.bool(True),
    tagInfoSources = cms.VInputTag(
        cms.InputTag("pfDeepFlavourTagInfosAK4PuppiFinal"), cms.InputTag("pfImpactParameterTagInfosAK4PuppiFinal"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAK4PuppiFinal"), cms.InputTag("pfParticleNetAK4TagInfosAK4PuppiFinal"), cms.InputTag("pfDeepCSVTagInfosAK4PuppiFinal"),
        cms.InputTag("pfParticleNetFromMiniAODAK4PuppiCentralTagInfosAK4PuppiFinal"), cms.InputTag("pfParticleTransformerAK4TagInfosAK4PuppiFinal"), cms.InputTag("pfUnifiedParticleTransformerAK4TagInfosAK4PuppiFinal")
    ),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
...
process.packedGenChargedParticles = cms.EDFilter("CandPtrSelector",
...
process.selectedUpdatedPatJetsAK4PuppiFinal = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("updatedPatJetsTransientCorrectedAK4PuppiFinal")
)


process.deepntuplizer = cms.EDAnalyzer("BareDeepNtuplizer",
    LooseSVs = cms.InputTag("looseIVFinclusiveCandidateSecondaryVertices"),
    SVs = cms.InputTag("slimmedSecondaryVertices"),
    SkipPU = cms.bool(True),
    ...
    genJetMatchRecluster = cms.InputTag("patGenChargedJetMatchRecluster"),
    genJetMatchWithNu = cms.InputTag("patGenJetMatchWithNu"),
    genJets = cms.InputTag("ak4GenChargedJetsRecluster"),
    ...
    jetPtMax = cms.double(400),
    jetPtMin = cms.double(5.0),
    jetR = cms.double(0.4),
    jets = cms.InputTag("selectedUpdatedPatJetsAK4PuppiFinal"),
    losttracks = cms.InputTag("lostTracks"),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('output_puppi_0.root')
)
...
process.patAlgosToolsTask = cms.Task(process.ak4PFJetsPuppiRecluster, process.packedpuppi, process.packedpuppiNoLep, process.patJetCorrFactorsAK4PuppiFinal, process.patJetCorrFactorsAK4PuppiRecluster, process.patJetCorrFactorsTransientCorrectedAK4PuppiFinal, process.patJetFlavourAssociationAK4PuppiRecluster, process.patJetFlavourAssociationLegacyAK4PuppiRecluster, process.patJetGenJetMatchAK4PuppiRecluster, process.patJetPartonAssociationLegacyAK4PuppiRecluster, process.patJetPartonMatchAK4PuppiRecluster, process.patJetPartonsLegacyRecluster, process.patJetPartonsRecluster, process.patJetsAK4PuppiRecluster, process.pfDeepCSVJetTagsAK4PuppiFinal, process.pfDeepCSVTagInfosAK4PuppiFinal, process.pfDeepFlavourJetTagsAK4PuppiFinal, process.pfDeepFlavourTagInfosAK4PuppiFinal, process.pfImpactParameterTagInfosAK4PuppiFinal, process.pfInclusiveSecondaryVertexFinderTagInfosAK4PuppiFinal, process.pfParticleNetAK4DiscriminatorsJetTagsAK4PuppiFinal, process.pfParticleNetAK4JetTagsAK4PuppiFinal, process.pfParticleNetAK4TagInfosAK4PuppiFinal, process.pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal, process.pfParticleNetFromMiniAODAK4PuppiCentralTagInfosAK4PuppiFinal, process.pfParticleTransformerAK4JetTagsAK4PuppiFinal, process.pfParticleTransformerAK4TagInfosAK4PuppiFinal, process.pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal, process.pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal, process.pfUnifiedParticleTransformerAK4TagInfosAK4PuppiFinal, process.puppi, process.puppiNoLep, process.selectedPatJetsAK4PuppiRecluster, process.selectedUpdatedPatJetsAK4PuppiFinal, process.updatedPatJetsAK4PuppiFinal, process.updatedPatJetsTransientCorrectedAK4PuppiFinal)


process.genJetReclusterTask = cms.Task(process.ak4GenChargedJetsRecluster, process.ak4GenJetsWithNu, process.packedGenChargedParticles)


process.genJetMatchTask = cms.Task(process.patGenChargedJetMatchRecluster, process.patGenJetMatchAllowDuplicates, process.patGenJetMatchWithNu)


process.tsk = cms.Task(process.QGTagger, process.ak4GenChargedJetsRecluster, process.ak4GenJetsWithNu, process.ak4PFJetsPuppiRecluster, process.looseIVFcandidateVertexArbitrator, process.looseIVFcandidateVertexArbitratorCvsL, process.looseIVFcandidateVertexArbitratorDefault, process.looseIVFcandidateVertexMerger, process.looseIVFcandidateVertexMergerCvsL, process.looseIVFinclusiveCandidateSecondaryVertices, process.looseIVFinclusiveCandidateSecondaryVerticesCvsL, process.looseIVFinclusiveCandidateVertexFinder, process.looseIVFinclusiveCandidateVertexFinderCvsL, process.looseIVFinclusiveCandidateVertexFinderDefault, process.looseIVFinclusiveSecondaryVertices, process.looseIVFinclusiveVertexFinder, process.looseIVFinclusiveVertexFinderDefault, process.looseIVFtrackVertexArbitrator, process.looseIVFtrackVertexArbitratorDefault, process.looseIVFvertexMerger, process.packedGenChargedParticles, process.packedpuppi, process.packedpuppiNoLep, process.patGenChargedJetMatchRecluster, process.patGenJetMatchAllowDuplicates, process.patGenJetMatchWithNu, process.patJetCorrFactorsAK4PuppiFinal, process.patJetCorrFactorsAK4PuppiRecluster, process.patJetCorrFactorsTransientCorrectedAK4PuppiFinal, process.patJetFlavourAssociationAK4PuppiRecluster, process.patJetFlavourAssociationLegacyAK4PuppiRecluster, process.patJetGenJetMatchAK4PuppiRecluster, process.patJetPartonAssociationLegacyAK4PuppiRecluster, process.patJetPartonMatchAK4PuppiRecluster, process.patJetPartonsLegacyRecluster, process.patJetPartonsRecluster, process.patJetsAK4PuppiRecluster, process.pfDeepCSVJetTagsAK4PuppiFinal, process.pfDeepCSVTagInfosAK4PuppiFinal, process.pfDeepFlavourJetTagsAK4PuppiFinal, process.pfDeepFlavourTagInfosAK4PuppiFinal, process.pfImpactParameterTagInfosAK4PuppiFinal, process.pfInclusiveSecondaryVertexFinderTagInfosAK4PuppiFinal, process.pfParticleNetAK4DiscriminatorsJetTagsAK4PuppiFinal, process.pfParticleNetAK4JetTagsAK4PuppiFinal, process.pfParticleNetAK4TagInfosAK4PuppiFinal, process.pfParticleNetFromMiniAODAK4PuppiCentralJetTagsAK4PuppiFinal, process.pfParticleNetFromMiniAODAK4PuppiCentralTagInfosAK4PuppiFinal, process.pfParticleTransformerAK4JetTagsAK4PuppiFinal, process.pfParticleTransformerAK4TagInfosAK4PuppiFinal, process.pfUnifiedParticleTransformerAK4DiscriminatorsJetTagsAK4PuppiFinal, process.pfUnifiedParticleTransformerAK4JetTagsAK4PuppiFinal, process.pfUnifiedParticleTransformerAK4TagInfosAK4PuppiFinal, process.primaryVertexAssociationJME, process.puppi, process.puppiNoLep, process.randomEngineStateProducer, process.selectedPatJetsAK4PuppiRecluster, process.selectedUpdatedPatJetsAK4PuppiFinal, process.updatedPatJetsAK4PuppiFinal, process.updatedPatJetsTransientCorrectedAK4PuppiFinal)


process.p = cms.Path(process.QGTagger+process.deepntuplizer, process.genJetMatchTask, process.genJetReclusterTask, process.patAlgosToolsTask, process.tsk)
