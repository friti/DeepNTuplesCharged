...
JetFlavor jet_flavour(const pat::Jet& jet,
    ...
    // di-tau 
    if(pos_matched_tauhtauh >= 0){
      jet_tauhtauhflav_b = 1;
    }
    else{
      jet_tauhtauhflav_b = 0;
    }
    if(pos_matched_tauhtaumu >= 0){
      jet_tauhtaumuflav_b = 1;
    }
    else{
      jet_tauhtaumuflav_b = 0;
    }
    if(pos_matched_tauhtaue >= 0){
      jet_tauhtaueflav_b = 1;
    }
    else{
      jet_tauhtaueflav_b = 0;
    }
    ...
    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taudecaymode_b==10) & (jet_taucharge_b>0)){return JetFlavor::TAUP3H0P;}
    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taudecaymode_b==11) & (jet_taucharge_b>0)){return JetFlavor::TAUP3H1P;}
    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taucharge_b>0)){return JetFlavor::TAUPOTHER;}


    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taudecaymode_b==0) & (jet_taucharge_b<0)){return JetFlavor::TAUM1H0P;}
    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taudecaymode_b==1) & (jet_taucharge_b<0)){return JetFlavor::TAUM1H1P;}
    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taudecaymode_b==2) & (jet_taucharge_b<0)){return JetFlavor::TAUM1H2P;}
    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taudecaymode_b==10) & (jet_taucharge_b<0)){return JetFlavor::TAUM3H0P;}
    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taudecaymode_b==11) & (jet_taucharge_b<0)){return JetFlavor::TAUM3H1P;}
    if((jet_muflav_b==0) & (jet_elflav_b==0) & (jet_tauflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0) & (jet_taucharge_b<0)){return JetFlavor::TAUMOTHER;}

    // di-tau (only one category for now)

    if((jet_muflav_b==0) & (jet_elflav_b==0)  & (jet_tauhtauhflav_b==1) & (jet_tauhtaumuflav_b==0) & (jet_tauhtaueflav_b==0)  ){return JetFlavor::DITAUH;}
    if((jet_muflav_b==0) & (jet_elflav_b==0)  & (jet_tauhtaumuflav_b==1) & (jet_tauhtauhflav_b==0) & (jet_tauhtaueflav_b==0)  ){return JetFlavor::DITAUMU;}
    if((jet_muflav_b==0) & (jet_elflav_b==0)  & (jet_tauhtaueflav_b==1) & (jet_tauhtaumuflav_b==0) & (jet_tauhtauhflav_b==0)  ){return JetFlavor::DITAUE;}
